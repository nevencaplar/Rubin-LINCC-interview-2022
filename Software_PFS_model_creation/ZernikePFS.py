...
class ZernikeFitterPFS(object):
    ...
    def _optPsf_postprocessing(self, optPsf, return_intermediate_images=False):
        ...
        if self.verbosity == 1:
            print('Shape of optPsf: ' + str(optPsf.shape))
            print('Value of oversampling_original: ' + str(oversampling_original))
        ...
        if oversampling_original < 20:
            ...
            oversampling = 11
        if self.verbosity == 1:
            print('Value of oversampling:' + str(oversampling))
    ...
    def _getOptPsf_naturalResolution(self, params, return_intermediate_images=False):
        ...
        if self.verbosity == 1:
            ...
            print('set of pupil_parameters I. : ' + str([params['detFrac'], params['strutFrac'],
                                                         params['dxFocal'], params['dyFocal'],
                                                         params['slitFrac'],  params['slitFrac_dy']]))
            print('set of pupil_parameters II. : ' + str([params['x_fiber'], params['y_fiber'],
                                                         params['effective_ilum_radius'],
                                                         params['slitHolder_frac_dx'],
                                                         params['frd_lorentz_factor'],
                                                         params['det_vert'],
                                                         params['slitHolder_frac_dx']]))
            print('set of pupil_parameters III. : ' + str([params['wide_0'], params['wide_23'],
